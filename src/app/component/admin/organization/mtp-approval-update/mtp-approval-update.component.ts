...
@Component({
  selector: 'app-mtp-approval-update',
  templateUrl: './mtp-approval-update.component.html',
  styleUrl: './mtp-approval-update.component.css',
  providers: [AdvancedService, DecimalPipe, BsDropdownModule]
})
export class MtpApprovalUpdateComponent {
