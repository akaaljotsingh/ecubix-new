...
export const MENU: MenuItem[] = [
    ...
    },
    {
        ...
        subItems: [
            {
                id: 1,
                label: 'MENUITEMS.USERMANAGEMENT.LIST.PERMISSIONCATEGORY',
            ...
            {
                id: 3,
                label: 'MENUITEMS.USERMANAGEMENT.LIST.CREATETASK',
                link: '/admin/tasks',
                parentId: 5
            },
            ...
            {
                id: 4,
                label: 'MENUITEMS.USERMANAGEMENT.LIST.CREATEMENU',
                link: '/admin/create-menu',
                parentId: 5
            },
            
            {
                id: 5,
                label: 'MENUITEMS.USERMANAGEMENT.LIST.CREATEROLE',
                link: '/admin/roles',
                parentId: 5
            },
            {
                id: 6,
                label: 'MENUITEMS.USERMANAGEMENT.LIST.PRODUCTUSER',
                link: '/admin/productuser',
                parentId: 5
            }
    ...
    },
    {
        ...
        subItems: [
            ...
            {
                id: 5,
                label: 'MENUITEMS.ONBOARDING.LIST.DIVISON',
                link: '/admin/add-division',
                parentId: 3
            },
            {
                id: 6,
                label: 'MENUITEMS.ONBOARDING.LIST.GEOGRAPHY',
                link: '/admin/geography',
                parentId: 3
            },
            {
                id: 7,
                label: 'MENUITEMS.ONBOARDING.LIST.EMPLOYEES',
                link: '/admin/employees',
                parentId: 3
            },
            {
                id: 8,
                label: 'MENUITEMS.ONBOARDING.LIST.EMPLOYEEFAMILYDETAILS',
                link: '/admin/familydetails',
                parentId: 3
            },
            // {
            //     id: 7,
            //     label: 'MENUITEMS.ONBOARDING.LIST.COMPANY_ROLES',
            //     link: '/admin/companyrole',
            //     parentId: 3
            // },
            
            // {
            //     id: 9,
            //     label: 'MENUITEMS.ONBOARDING.LIST.EMPLOYEES_DIVISION_MAPPING',
            //     link: '/admin/empdivisonmap',
            //     parentId: 3,
            // },
            // {
            //     id: 8,
            //     label: 'MENUITEMS.ONBOARDING.LIST.leave1',
            //     link: '/admin/leave1',
            //     parentId: 3
            // },
            // {
            //     id: 9,
            //     label: 'MENUITEMS.ONBOARDING.LIST.leave2',
            //     link: '/admin/leave2',
            //     parentId: 3,
            // }
    ...
    
    {
        ...
        subItems: [
            ...
            {
                id: 1,
                label: 'MENUITEMS.MISCELLANEOUSSETTING.LIST.BROADCAST',
    ...
    
    {
      /*  id: 4,
        ...
        subItems: [
                        {
                id: 10,
                label: 'MENUITEMS.TOUR.LIST.companylevelconfig',
                link: '/admin/companylevelconfig',
                parentId: 4,
            },
            {
                id: 11,
                label: 'MENUITEMS.TOUR.LIST.divisionlevelconfig',
                link: '/admin/divisionlevelconfig',
                parentId: 4,
            },
            {
                id: 12,
                label: 'MENUITEMS.TOUR.LIST.mtptourplan',
                link: '/admin/mtptourplan',
                parentId: 4,
            },
            {
                id: 13,
                label: 'MENUITEMS.TOUR.LIST.stptourplan',
                link: '/admin/stptourplan',
                parentId: 4,
            },
            {
                id: 14,
                label: 'MENUITEMS.TOUR.LIST.mtptourapproval',
                link: '/admin/mtptourapproval',
                parentId: 4,
            },
            {
                id: 15,
                label: 'MENUITEMS.TOUR.LIST.tourplan',
                link: '/admin/tourplan',
                parentId: 4,
            }
